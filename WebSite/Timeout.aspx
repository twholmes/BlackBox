<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BlackBox.TimeoutPage" Title="BlackBox" %>
...
<body>
   ...
   **** MAIN CONTENT PANEL
   ...
   <br/>
   <dx:ASPxLabel ID="TimeoutLabel" runat="server" ClientIDMode="Static" Text="Session Timeout" Font-Bold="True" Font-Size="32px" ForeColor="Red" Width="700px" />
   <br/>
   <dx:ASPxLabel ID="WelcomeLabel" runat="server" ClientIDMode="Static" Text="Please click on the Home button below" Font-Bold="True" Font-Size="32px" ForeColor="#616161" Width="700px" />
   <br/>
          ...
          <dx:LayoutGroup Name="RefreshButton" Caption="Reauthenticate" ShowCaption="false" ColCount="1" SettingsItems-HorizontalAlign="Left" HorizontalAlign="Left" Width="500">
              <Items>
                  <dx:LayoutItem ShowCaption="False" CssClass="buttonAlign" Width="100%">
                      <LayoutItemNestedControlCollection>
                          <dx:LayoutItemNestedControlContainer runat="server" SupportsDisabledAttribute="True">
                              <dx:ASPxButton ID="HomeButton" runat="server" Text="Home" OnClick="HomeButtonClick" Width="100" />                                   
                          </dx:LayoutItemNestedControlContainer>
                      </LayoutItemNestedControlCollection>
                  </dx:LayoutItem>
              </Items>
