<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Advanced.master" CodeBehind="Uploads.aspx.cs" Inherits="BlackBox.AdvancedUploadsPage" Title="BlackBox" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolderHead">  
  ...
  { 
    ...
    if (toolbar != null) 
    {  
      //var btSubmit = toolbar.Items["CustomStageLoadedData"];  btSubmit.enabled = false;
    }
  ...
  function OnGridViewImportsToolbarItemClick(s, e) 
  {
   ...
   else
   {
     ...
     switch(e.item.name) 
     {
       ...
       //case "CustomScheduleUploadedFile":
       //   memoActionMessage.SetText("Schedule file for auto processing?");
       //   pcAction.Show();
       //   btActionCancel.Focus(); 
       //   break;

       //case "CustomRecallUploadedFile":
       //   memoActionMessage.SetText("Set file for manual processing?");
       //   pcAction.Show();
       //   btActionCancel.Focus(); 
       //   break;
  ...
  {
    openUrlWithParamFromPage("../Advanced/Spreadsheet.aspx", "fid", fid, true);
  }
                ...
                <Template>
                     <table>
                       <tr style="padding: inherit; margin: 2px 2px 2px 2px; vertical-align: middle; height: 46px; text-indent: 8px;">
                         <td>
                           <dx:ASPxHyperLink ID="BreadcrumbsHyperLink" runat="server" NavigateUrl="~/Manager.aspx" Text="Base" Font-Bold="True" Font-Size="Large" Border-BorderStyle="None" Border-BorderWidth="8px" />
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolderMenu">
    ...
    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar" 
       ...
       <Items>
          <dx:MenuItem Name="PageMenuValidations" Text="Validation Results" Alignment="Right" AdaptivePriority="1">
              ...
              <ContentCollection>
                  ...
                  <dx:ASPxGridView ID="DataSourcesGridView" runat="server" ClientInstanceName="gridViewDataSources" DataSourceID="SqlBlackBoxDataSources" KeyFieldName="Name"                   
                    ...
                    <Columns>
                          ...
                          <dx:GridViewDataTextColumn FieldName="Name" VisibleIndex="1" Width="190px" Visible="true" />
                          <dx:GridViewDataTextColumn FieldName="Group" VisibleIndex="2" Width="110px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Description" VisibleIndex="3" Width="210px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="TypeID" VisibleIndex="4" Width="80px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Type" VisibleIndex="5" Width="90px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Template" VisibleIndex="6" Width="260px" Visible="true" />                            
                          <dx:GridViewDataTextColumn FieldName="Datasets" VisibleIndex="7" Width="200px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Prefix" VisibleIndex="8" Width="100px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="StatusID" VisibleIndex="9" Width="80px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Status" VisibleIndex="10" Width="90px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Locked" VisibleIndex="11" Width="100px" Visible="false" />                            
                    ...
                    <Toolbars>
                        <dx:GridViewToolbar>
                            ...
                            <Items>
                                ...
                                <dx:GridViewToolbarItem Text="Automation" BeginGroup="true" AdaptivePriority="4">
                                    <Items>
                                        <dx:GridViewToolbarItem Name="CustomScheduleUploadedFile" Text="Schedule" BeginGroup="false" Enabled="false" />
                                        <dx:GridViewToolbarItem Name="CustomRecallUploadedFile" Text="Recall" BeginGroup="false" Enabled="false" />                                          
                                    </Items>
                                </dx:GridViewToolbarItem>  

                                <dx:GridViewToolbarItem Name="CustomLoadFileData" Text="Load" BeginGroup="true" AdaptivePriority="6" Enabled="false" /> 
                                                                   
                                <dx:GridViewToolbarItem Name="CustomValidateLoadedData" Text="Validate" BeginGroup="true" AdaptivePriority="7" Enabled="false" />

                                <dx:GridViewToolbarItem Text="Staging" BeginGroup="true" AdaptivePriority="8">
                                    <Items>
                                        <dx:GridViewToolbarItem Name="CustomStageLoadedData" Text="Stage" BeginGroup="false" Enabled="false" />
                                        <dx:GridViewToolbarItem Name="CustomRejectStaged" Text="Reject" BeginGroup="false" Enabled="false" />                                          
                                    </Items>
                                </dx:GridViewToolbarItem>
                    
                                <dx:GridViewToolbarItem Name="CustomPublishStaged" Text="Publish" BeginGroup="true" AdaptivePriority="9" Enabled="false" />
                                   
                                <dx:GridViewToolbarItem Name="CustomWithdrawStaged" Text="Withdraw" BeginGroup="true" AdaptivePriority="10" Enabled="false" />
                                <dx:GridViewToolbarItem Name="CustomArchiveStaged" Text="Archive" BeginGroup="true" AdaptivePriority="11" Enabled="false" />
                            </Items>
                        </dx:GridViewToolbar>
                    </Toolbars>                     
                    <SettingsPopup>
