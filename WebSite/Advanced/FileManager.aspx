<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Advanced.master" CodeBehind="FileManager.aspx.cs" Inherits="BlackBox.AdvancedFileManagerPage" Title="BlackBox" %>
                ...
                <Template>
                     <table>
                       <tr style="padding: inherit; margin: 2px 2px 2px 2px; vertical-align: middle; height: 46px; text-indent: 8px;">
                         <td>
                           <dx:ASPxHyperLink ID="BreadcrumbsHyperLink" runat="server" NavigateUrl="~/Admin.aspx" Text="Advanced" Font-Bold="True" Font-Size="Large" Border-BorderStyle="None" Border-BorderWidth="8px" />
    ...
    <dx:ASPxPageControl ID="TabPagesMainPanel" Width="100%" runat="server" ActiveTabIndex="0" EnableHierarchyRecreation="True" >
        <TabPages>           
           ...
           **** TASKFILES TABPAGE
           ...
           <dx:TabPage Text="Task Files">
              <ContentCollection>
                  <dx:ContentControl ID="MainContentControl2" runat="server">
                  	
                  <dx:ASPxFileManager ID="TasksFileManager" ClientInstanceName="TasksFileManager" runat="server" Width="95%" Height="750px"
                      OnCustomCallback="TasksFileManager_CustomCallback" OnCustomThumbnail="OnFileManagerCustomThumbnails"
                      OnItemDeleting="TasksFileManager_ItemDeleting" OnItemMoving="TasksFileManager_ItemMoving" OnItemsDeleted="TasksFileManager_ItemsDeleted" OnItemMoved="TasksFileManager_ItemMoved"
                      OnItemRenaming="TasksFileManager_ItemRenaming" OnItemCopying="TasksFileManager_ItemCopying" OnItemRenamed="TasksFileManager_ItemRenamed" OnItemsCopied="TasksFileManager_ItemsCopied"
                      OnFileUploading="TasksFileManager_FileUploading" OnFolderCreating="TasksFileManager_FolderCreating">
                      <Settings RootFolder="~/Tasks" ThumbnailFolder="~/Resources/Thumbnails"
           ...
           **** SCRIPT TABPAGE
           ...
           <dx:TabPage Text="Script Files">
              <ContentCollection>
                  <dx:ContentControl ID="MainContentControl3" runat="server">
                  	
                  <dx:ASPxFileManager ID="ScriptsFileManager" ClientInstanceName="ScriptsFileManager" runat="server" Width="95%" Height="750px"
                      OnCustomCallback="ScriptsFileManager_CustomCallback" OnCustomThumbnail="OnFileManagerCustomThumbnails"
                      OnItemDeleting="ScriptsFileManager_ItemDeleting" OnItemMoving="ScriptsFileManager_ItemMoving" OnItemsDeleted="ScriptsFileManager_ItemsDeleted" OnItemMoved="ScriptsFileManager_ItemMoved"
                      OnItemRenaming="ScriptsFileManager_ItemRenaming" OnItemCopying="ScriptsFileManager_ItemCopying" OnItemRenamed="ScriptsFileManager_ItemRenamed" OnItemsCopied="ScriptsFileManager_ItemsCopied"
                      OnFileUploading="ScriptsFileManager_FileUploading" OnFolderCreating="ScriptsFileManager_FolderCreating">
                      <Settings RootFolder="~/Scripts" ThumbnailFolder="~/Resources/Thumbnails"
                          AllowedFileExtensions=".csv,.xls,.xlsx"
                          InitialFolder="~/Scripts" />
                      <SettingsEditing AllowCreate="true" AllowDelete="true" AllowMove="true" AllowRename="true" AllowCopy="true" AllowDownload="true" />
                      <SettingsPermissions>
                          <AccessRules>
                              <dx:FileManagerFolderAccessRule Path="system" Edit="Deny" />
           ...
           **** ADAPTER TABPAGE
           ...
           <dx:TabPage Text="Adapter Files">
              <ContentCollection>
                  <dx:ContentControl ID="MainContentControl4" runat="server">
                  	
                  <dx:ASPxFileManager ID="AdapterFileManager" ClientInstanceName="AdapterFileManager" runat="server" Width="95%" Height="750px"
                      OnCustomCallback="AdapterFileManager_CustomCallback" OnCustomThumbnail="OnFileManagerCustomThumbnails"
                      OnItemDeleting="AdapterFileManager_ItemDeleting" OnItemMoving="AdapterFileManager_ItemMoving" OnItemsDeleted="AdapterFileManager_ItemsDeleted" OnItemMoved="AdapterFileManager_ItemMoved"
                      OnItemRenaming="AdapterFileManager_ItemRenaming" OnItemCopying="AdapterFileManager_ItemCopying" OnItemRenamed="AdapterFileManager_ItemRenamed" OnItemsCopied="AdapterFileManager_ItemsCopied"
                      OnFileUploading="AdapterFileManager_FileUploading" OnFolderCreating="AdapterFileManager_FolderCreating">
                      <Settings RootFolder="~/Adapters" ThumbnailFolder="~/Resources/Thumbnails"
                          AllowedFileExtensions=".csv,.xls,.xlsx"
                          InitialFolder="~/Adapters" />
                      <SettingsEditing AllowCreate="true" AllowDelete="true" AllowMove="true" AllowRename="true" AllowCopy="true" AllowDownload="true" />
                      <SettingsPermissions>
                          <AccessRules>
                              <dx:FileManagerFolderAccessRule Path="system" Edit="Deny" />
           ...
           **** LOGS TABPAGE
           ...
           <dx:TabPage Text="Log Files">
              <ContentCollection>
                  <dx:ContentControl ID="MainContentControl5" runat="server">
