<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Base.master" CodeBehind="FileManager.aspx.cs" Inherits="BlackBox.BaseFileManagerPage" Title="BlackBox" %>
                ...
                <Template>
                     <table>
                       <tr style="padding: inherit; margin: 2px 2px 2px 2px; vertical-align: middle; height: 46px; text-indent: 8px;">
                         <td>
                           <dx:ASPxHyperLink ID="BreadcrumbsHyperLink" runat="server" NavigateUrl="~/Home.aspx" Text="Base" Font-Bold="True" Font-Size="Large" Border-BorderStyle="None" Border-BorderWidth="8px" />
    ...
    <dx:ASPxPageControl ID="TabPagesMainPanel" Width="100%" runat="server" ActiveTabIndex="0" EnableHierarchyRecreation="True" >
        <TabPages>           
           ...
           **** TEMPLATE TABPAGE
           ...
           <dx:TabPage Text="Template Files">
              <ContentCollection>
                  <dx:ContentControl ID="MainContentControl2" runat="server">
                  	
                  <dx:ASPxFileManager ID="TemplatesFileManager" ClientInstanceName="TemplatesFileManager" runat="server" Width="95%" Height="750px"
                      OnCustomCallback="TemplatesFileManager_CustomCallback" OnCustomThumbnail="OnFileManagerCustomThumbnails"
                      OnItemDeleting="TemplatesFileManager_ItemDeleting" OnItemMoving="TemplatesFileManager_ItemMoving" OnItemsDeleted="TemplatesFileManager_ItemsDeleted" OnItemMoved="TemplatesFileManager_ItemMoved"
                      OnItemRenaming="TemplatesFileManager_ItemRenaming" OnItemCopying="TemplatesFileManager_ItemCopying" OnItemRenamed="TemplatesFileManager_ItemRenamed" OnItemsCopied="TemplatesFileManager_ItemsCopied"
                      OnFileUploading="TemplatesFileManager_FileUploading" OnFolderCreating="TemplatesFileManager_FolderCreating">
