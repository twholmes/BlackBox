<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuperAdmin.aspx.cs" Inherits="BlackBox.SuperAdminPage" Title="BlackBox" %>
   ...
   <form id="PageForm" runat="server" class="form">
      ...
      **** LEFT PANEL
      ...
      <dx:ASPxPanel runat="server" ID="LeftPanel" ClientInstanceName="leftPanel"
          ...
          <PanelCollection>
              ...
              <%-- this is an super-admin level menu --%>
              <dx:ASPxMenu ID="ASPxMenuAdvanced" runat="server" ClientInstanceName="advancedMenu" Orientation="Vertical" 
                  BackColor="#000066" Font-Bold="False" Font-Size="Large" ForeColor="White" HorizontalAlign="Left" VerticalAlign="Middle" 
                  Width="100%" AllowSelectItem="True" AppearAfter="10" ItemWrap="False" MaximumDisplayLevels="1" LinkStyle-HoverColor="#6699FF">
                  <Border BorderColor="#000066" />
                  <BorderBottom BorderColor="#000066" BorderWidth="20px" />                        
                  <SettingsAdaptivity Enabled="true" EnableAutoHideRootItems="False" EnableCollapseRootItemsToIcons="true" CollapseRootItemsToIconsAtWindowInnerWidth="200" />                        
                  <Items> 
                      <dx:MenuItem Name="MainMenuSystem" Text="Uploads" NavigateUrl="~/Advanced/Uploads.aspx">
                          <Image IconID="scheduling_import_svg_white_32x32" />
                      </dx:MenuItem>                  	      
                      <dx:MenuItem Name="MainMenuCards" Text="Cards" NavigateUrl="~/Advanced/Cards.aspx">
                          <Image IconID="iconbuilder_shopping_box_svg_white_32x32" />                          
                      </dx:MenuItem>                  	      
                  </Items>
                  <ItemStyle VerticalAlign="Middle" ForeColor="White">
              ...
              <dx:ASPxMenu ID="ASPxMenuAdministrator" runat="server" ClientInstanceName="mainMenu" Orientation="Vertical" 
                  ...
                  <SettingsAdaptivity Enabled="true" EnableAutoHideRootItems="False" EnableCollapseRootItemsToIcons="true" CollapseRootItemsToIconsAtWindowInnerWidth="200" />
                  <Items>
                      <dx:MenuItem Name="MainMenuFileManager" Text="File Manager" BeginGroup="true" NavigateUrl="~/Admin/FileManager.aspx">
                          <Image IconID="actions_open2_svg_white_32x32" />
                      </dx:MenuItem>
                      <dx:MenuItem Name="MainMenuProcessLogs" NavigateUrl="~/Admin/Logs.aspx" Text="Process Logs">
              ...
              <%-- this is an super administrator level menu --%>
              <dx:ASPxMenu ID="ASPxMenuSuper" runat="server" ClientInstanceName="superMenu" Orientation="Vertical" 
                  BackColor="#000066" Font-Bold="False" Font-Size="Large" ForeColor="White" HorizontalAlign="Left" VerticalAlign="Middle" 
                  Width="100%" AllowSelectItem="True" AppearAfter="10" ItemWrap="False" MaximumDisplayLevels="1" LinkStyle-HoverColor="#6699FF">
                  <Border BorderColor="#000066" />
                  <BorderBottom BorderColor="#000066" BorderWidth="20px" />                        
                         ...
                         **** SETTINGS TABPAGE
                         ...
                         <dx:TabPage Text="Settings" Visible="false">
                            <ContentCollection>
                                ...
                                <dx:ASPxGridView runat="server" ID="SettingsGridView" ClientInstanceName="gridViewSettings" DataSourceID="SettingsDataModelSource" KeyFieldName="Group;Name"
                                    EnablePagingGestures="False" CssClass="grid-view" Width="100%"
                                    OnCustomCallback="SettingsGridView_CustomCallback" OnInitNewRow="SettingsGridView_InitNewRow" AutoGenerateColumns="False">
                                    <Columns>
                                  ...
                                  <Template>
                                       <table>
                                         <tr style="padding: inherit; margin: 2px 2px 2px 2px; vertical-align: middle; height: 46px; text-indent: 8px;">
                                           <td>
                                             <dx:ASPxLabel ID="BreadcrumbsLabel" runat="server" Text="SuperAdmin Page" Font-Bold="True" Font-Size="Large" Width="750px" />
                                           </td>
                                           <td>&nbsp;</td>
                                         </tr>
                                       </table>
                                      ...
                                      <dx:LayoutItem ShowCaption="False">
                                          <LayoutItemNestedControlCollection>
                                              <dx:LayoutItemNestedControlContainer>
                                                  ...
                                                  <dx:ASPxButton ID="btUserPages" runat="server" Text="User Pages" Width="80px" AutoPostBack="False" Style="float: left; margin-right: 8px">
                                                      <ClientSideEvents Click="function(s, e) { pcSystem.Hide(); window.open('home.aspx','_self'); }" />
                                                  </dx:ASPxButton>
      ...
      **** MAIN CONTENT PANEL
      ...
      <div class="content" ID="ContentPlaceHolderContent">
        ...
        <dx:ASPxPageControl ID="tabPageProperties" Width="100%" runat="server" ActiveTabIndex="0" EnableHierarchyRecreation="True" >
            <TabPages>        
     ...
     **** RIGHT-PANEL DATA SOURCES
     ...
     <asp:XmlDataSource ID="SettingsXmlDataSource" runat="server" DataFile="~/App_Data/Settings.xml" XPath="//settings/setting" />
      
     <%-- <asp:ObjectDataSource ID="SettingsDataModelSource" runat="server" DataObjectTypeName="BlackBox.Helper.Setting" TypeName="BlackBox.Model.DataProvider" --%>      
     <asp:ObjectDataSource ID="SettingsDataModelSource" runat="server" TypeName="BlackBox.Model.SettingsProvider"
        ...
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="General" Name="Group" QueryStringField="Group" Type="String" />
        </SelectParameters>
