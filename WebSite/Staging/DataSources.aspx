<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Staging.Master" CodeBehind="DataSources.aspx.cs" Inherits="BlackBox.DataSourcesPage" Title="BlackBox" %>
                     ...
                     <table>
                       <tr style="padding: inherit; margin: 2px 2px 2px 2px; vertical-align: middle; height: 46px; text-indent: 8px;">
                         <td>
                           ...
                           <dx:ASPxLabel ID="BreadcrumbsLabel" runat="server" Text="DataSources" Font-Bold="true" Font-Size="Large" Width="280px" />
                         </td>
                         <td>&nbsp;</td>
                       </tr>
                     </table>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolderPageContent" runat="server">    
   ...
   <asp:SqlDataSource ID="SqlBlackBoxDataSources" runat="server" 
      ...
      SelectCommand="SELECT [Name],[Group],[Description],[TypeID],[Type],[Datasets],[Prefix],[StatusID],[Status],[Locked],[Icon],[TimeStamp],[Age] FROM [dbo].[vBlackBoxDataSources] WHERE [Group] like @group ORDER BY [Name] DESC"
      InsertCommand="INSERT INTO [dbo].[BlackBoxDataSources] ([Name],[Group],[Description],[TypeID],[Datasets],[Prefix],[StatusID],[Locked],[TimeStamp]) VALUES(@name,@group,@description,@typeid,@datasets,@prefix,@statusid,@locked,@timestamp)"
      UpdateCommand="UPDATE [dbo].[BlackBoxDataSources] SET [Group]=@group,[Description]=@description,[TypeID]=@typeid,[Datasets]=@datasets,[Prefix]=@prefix,[StatusID]=@statusid,[Locked]=@locked,[TimeStamp]=@timestamp WHERE [Name] = @name"
   ...
   <asp:SqlDataSource ID="SqlBlackBoxDataSourceInstances" runat="server" 
      ConnectionString="<%$ ConnectionStrings:BlackBoxConnectionString %>" 
      SelectCommand="SELECT TOP(100) [ID],[Name],[Group],[Comment],[TypeID],[Type],[Locked],[AllowedDatasets],[ReferenceID],[Source],[Datasets],[Prefix],[JOBID],[GUID],[StatusID],[Status],[Locked],[TimeStamp],[Age] FROM [dbo].[vBlackBoxDataSourceInstances] ORDER BY [TimeStamp] DESC"
      InsertCommand="INSERT INTO [dbo].[BlackBoxDataSourceInstances] ([ID],[Name],[Group],[Comment],[TypeID],[ReferenceID],[Source],[Datasets],[Prefix],[JOBID],[GUID],[StatusID],[Locked],[TimeStamp]) VALUES(@name,@group,@comment,@typeid,@refid,@source,@datasets,@prefix,@jobid,@guid,@statusid,@locked,@timestamp)"
      UpdateCommand="UPDATE [dbo].[BlackBoxDataSourceInstances] SET [Name]=@name,[Group]=@group,[Comment]=@comment,[TypeID]=@typeid,[ReferenceID]=@refid,[Source]=@source,[Datasets]=@datasets,[Prefix]=@prefix,[JOBID]=@jobid,[GUID]=@guid,[StatusID]=@statusid,[Locked]=@locked,[TimeStamp]=@timestamp WHERE [ID] = @id"
              ...
              <ContentCollection>
                  ...
                  <dx:ASPxGridView ID="DataSourcesGridView" runat="server" ClientInstanceName="gridViewDataSources" DataSourceID="SqlBlackBoxDataSources" KeyFieldName="Name"                  	
                    ...
                    <Columns>
                          ...
                          <dx:GridViewDataTextColumn FieldName="Description" VisibleIndex="3" Width="300px" Visible="true" />
                          ...
                          <dx:GridViewDataTextColumn FieldName="Datasets" VisibleIndex="6" Width="340px" Visible="true" />
                          <dx:GridViewDataTextColumn FieldName="Prefix" VisibleIndex="7" Width="100px" Visible="true" />
                          <dx:GridViewDataTextColumn FieldName="StatusID" VisibleIndex="8" Width="80px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Status" VisibleIndex="9" Width="90px" Visible="true" />
                          <dx:GridViewDataTextColumn FieldName="Locked" VisibleIndex="10" Width="100px" Visible="true" />                          	
                          <dx:GridViewDataTextColumn FieldName="Icon" VisibleIndex="11" Width="200px" Visible="false" />
                          <dx:GridViewDataDateColumn FieldName="TimeStamp" VisibleIndex="12" Width="120px" Visible="true" />
                          <dx:GridViewDataTextColumn FieldName="Age" VisibleIndex="13" Width="80px" Visible="false" />                            
                      </Columns>
              ...
              <ContentCollection>
                  ...
                  <dx:ASPxGridView ID="DataSourceInstancesGridView" runat="server" ClientInstanceName="gridViewDataSourceInstances" DataSourceID="SqlBlackBoxDataSourceInstances" KeyFieldName="ID"
                    ...
                    <Columns>
                          ...
                          <dx:GridViewDataTextColumn FieldName="Locked" VisibleIndex="15" Width="100px" Visible="true" />
                          <dx:GridViewDataTextColumn FieldName="Source" VisibleIndex="16" Width="1200px" Visible="true" />
                          <dx:GridViewDataDateColumn FieldName="TimeStamp" VisibleIndex="17" Width="120px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Age" VisibleIndex="17" Width="80px" Visible="false" />                            
                      </Columns>
                      <SettingsPager PageSize="10" AlwaysShowPager="true" EllipsisMode="OutsideNumeric" EnableAdaptivity="true">
                          <PageSizeItemSettings Visible="true"></PageSizeItemSettings>
                      </SettingsPager>
