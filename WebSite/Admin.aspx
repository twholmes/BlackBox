<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="BlackBox.AdminPage" Title="BlackBox" %>
...
<body>
   ...
   <dx:ASPxPanel runat="server" ID="LeftPanel" ClientInstanceName="leftPanel"
       ...
       CssClass="left-panel" Paddings-Padding="0" BackColor="#660033">
       <Styles>
       ...
       <PanelCollection>
           ...
           <dx:ASPxMenu ID="ASPxMenuTop" runat="server" ClientInstanceName="topMenu" Orientation="Vertical" 
               BackColor="#660033" Font-Bold="True" Font-Size="X-Large" ForeColor="White" HorizontalAlign="Left" VerticalAlign="Middle" 
               Width="100%" AllowSelectItem="True" AppearAfter="10" ItemWrap="False" MaximumDisplayLevels="1" LinkStyle-HoverColor="#6699FF">
               <Border BorderColor="#660033" />
               <BorderBottom BorderColor="#660033" BorderWidth="20px" />
           ...
           <dx:ASPxMenu ID="ASPxMenuHome" runat="server" ClientInstanceName="homeMenu" Orientation="Vertical" 
               BackColor="#660033" Font-Bold="False" Font-Size="Large" ForeColor="White" HorizontalAlign="Left" VerticalAlign="Middle" 
               Width="100%" AllowSelectItem="True" AppearAfter="10" ItemWrap="False" MaximumDisplayLevels="1" LinkStyle-HoverColor="#6699FF">
               <Border BorderColor="#660033" />
               <BorderBottom BorderColor="#660033" BorderWidth="20px" />                        
               <SettingsAdaptivity Enabled="true" EnableAutoHideRootItems="False" EnableCollapseRootItemsToIcons="true" CollapseRootItemsToIconsAtWindowInnerWidth="200" />                        
           ...
           <%-- this is an admin level menu --%>
           <dx:ASPxMenu ID="ASPxMenuAdvanced" runat="server" ClientInstanceName="systemMenu" Orientation="Vertical" 
               BackColor="#660033" Font-Bold="False" Font-Size="Large" ForeColor="White" HorizontalAlign="Left" VerticalAlign="Middle" 
               Width="100%" AllowSelectItem="True" AppearAfter="10" ItemWrap="False" MaximumDisplayLevels="1" LinkStyle-HoverColor="#6699FF">
               <Border BorderColor="#660033" />
               <BorderBottom BorderColor="#660033" BorderWidth="20px" />                        
               <SettingsAdaptivity Enabled="true" EnableAutoHideRootItems="False" EnableCollapseRootItemsToIcons="true" CollapseRootItemsToIconsAtWindowInnerWidth="200" />                        
               <Items> 
                   <dx:MenuItem Name="MainMenuImports" NavigateUrl="~/Advanced/Uploads.aspx" Text="Uploads">
                       <Image IconID="scheduling_import_svg_white_32x32" />
                   </dx:MenuItem>
                   <dx:MenuItem Name="MainMenuFileManager" NavigateUrl="~/Advanced/FileManager.aspx" Text="File Manager">
           ...
           <dx:ASPxMenu ID="ASPxMenuSupport" runat="server" ClientInstanceName="supportMenu" Orientation="Vertical"
               BackColor="#660033" Font-Bold="False" Font-Size="Large" ForeColor="White" HorizontalAlign="Left" VerticalAlign="Bottom" 
               Width="100%" AllowSelectItem="True" AppearAfter="10" ItemWrap="False" MaximumDisplayLevels="1" LinkStyle-HoverColor="#6699FF">
               <Border BorderColor="#660033" />
               <BorderBottom BorderColor="#660033" BorderWidth="20px" />                        
               <SettingsAdaptivity Enabled="true" EnableAutoHideRootItems="False" EnableCollapseRootItemsToIcons="true" CollapseRootItemsToIconsAtWindowInnerWidth="200" />                        
                                  ...
                                  <Template>
                                       <table>
                                         <tr style="padding: inherit; margin: 2px 2px 2px 2px; vertical-align: middle; height: 46px; text-indent: 8px;">
                                           <td>
                                             <dx:ASPxLabel ID="BreadcrumbsLabel" runat="server" Text="Admin Page" Font-Bold="True" Font-Size="Large" Width="750px" />
                                           </td>
                                           <td>&nbsp;</td>
                                         </tr>
                                       </table>
