...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolderMenu">
    ...
    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar" 
       ...
       <Items>
          <dx:MenuItem Name="PageMenuJobFiles" Text="Job Files" Alignment="Right" AdaptivePriority="1">
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolderPageContent" runat="server">
   ...
   **** CONTENT PANEL DATA SOURCES
   ...
   <dx:ASPxSplitter runat="server" id="ASPxSplitter3" ResizingMode="Live" >
       <Panes>
           <dx:SplitterPane AutoHeight="False" Size="20%" MinSize="110px" >
               <ContentCollection>
                   ...
                   <dx:ASPxFileManager runat="server" ID="DataFileManager" ClientInstanceName="DataFileManager" Height="700"
                       OnFolderCreating="FileManager3_FolderCreating" OnItemDeleting="FileManager3_ItemDeleting" OnItemMoving="FileManager3_ItemMoving" 
                       OnCustomThumbnail="OnFileManagerCustomThumbnails" OnItemRenaming="FileManager3_ItemRenaming" OnFileUploading="FileManager3_FileUploading" 
                       OnItemCopying="FileManager3_ItemCopying">
                       ...
                       <SettingsAdaptivity Enabled="true" />
                       <ClientSideEvents SelectedFileChanged="OnDataFileChanged" CallbackError="OnExceptionOccurred"></ClientSideEvents>
                   </dx:ASPxFileManager>                  
           ...
           <dx:SplitterPane AutoHeight="True" Size="80%" MinSize="280px" >
               <ContentCollection>
                   ...
                   <dx:ASPxSpreadsheet ID="Spreadsheet" runat="server" ClientInstanceName="Spreadsheet" Width="100%" Height="800px" RibbonMode="Auto" ActiveTabIndex="0" ShowConfirmOnLosingChanges="false"
