<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="BlackBox.HomePage" Title="BlackBox" %>
                                  ...
                                  <Template>
                                       <table>
                                         <tr style="padding: inherit; margin: 2px 2px 2px 2px; vertical-align: middle; height: 46px; text-indent: 8px;">
                                           <td>
                                             <dx:ASPxLabel ID="BreadcrumbsLabel" runat="server" Text="Home Page" Font-Bold="True" Font-Size="Large" Width="750px" />
                                           </td>
                                           <td>&nbsp;</td>
                                         </tr>
                                       </table>
