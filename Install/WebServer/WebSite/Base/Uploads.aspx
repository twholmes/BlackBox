<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Base.master" CodeBehind="Uploads.aspx.cs" Inherits="BlackBox.BaseUploadsPage" Title="BlackBox" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolderHead">  
  ...
  {
    openUrlWithParamFromPage("../Base/Spreadsheet.aspx", "fid", fid, true);
  }
                            ...
                            <Items>
                                ...
                                <dx:GridViewToolbarItem Text="Steps" BeginGroup="true" AdaptivePriority="3">
                                    <Items>
                                        ...
                                        <dx:GridViewToolbarItem Name="CustomLoadStep" Text="Load" BeginGroup="true" Enabled="false" />
                                ...
                                <dx:GridViewToolbarItem Name="CustomScheduleStep" Text="Schedule" BeginGroup="true" AdaptivePriority="6" Enabled="false" />
                                                                   
                                <dx:GridViewToolbarItem Name="CustomValidateStep" Text="Validate" BeginGroup="true" AdaptivePriority="7" Enabled="false" />
