<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Staging.Master" CodeBehind="Datasets.aspx.cs" Inherits="BlackBox.DatasetsPage" Title="BlackBox" %>
                     ...
                     <table>
                       <tr style="padding: inherit; margin: 2px 2px 2px 2px; vertical-align: middle; height: 46px; text-indent: 8px;">
                         <td>
                           ...
                           <dx:ASPxLabel ID="BreadcrumbsLabel" runat="server" Text="Datasets" Font-Bold="True" Font-Size="Large" Width="280px" />
                         </td>
                         <td>&nbsp;</td>
                       </tr>
                     </table>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPlaceHolderPageContent" runat="server">    
   ...
   <asp:SqlDataSource ID="SqlBlackBoxDatasetUpdates" runat="server" 
      ...
      InsertCommand="INSERT INTO [dbo].[BlackBoxDatasetUpdates] ([Name],[Group],[TableName],[Flags],[Comment],[JOBID],[GUID],[DataSourceInstanceID],[DataSource],[Rows],[StatusID],[TimeStamp]) VALUES(@name,@group,@tablename,@flags,@comment,@jobid,@guid,@dsiid,@source,@rows,@statusid,@timestamp)"
      UpdateCommand="UPDATE [dbo].[BlackBoxDatasetUpdates] SET [Name]=@name,[Group]=@group,[TableName]=@tablename,[Flags]=@flags,[Comment]=@comment,[JOBID]=@jobid,[GUID]=@guid,[DataSourceInstanceID]=@dsiid,[DataSource]=@source,[Rows]=@rows,[StatusID]=@statusid,[TimeStamp]=@timestamp WHERE [ID] = @id"
              ...
              <ContentCollection>
                  ...
                  <dx:ASPxGridView ID="DatasetUpdatesGridView" runat="server" ClientInstanceName="gridViewDatasetUpdates" DataSourceID="SqlBlackBoxDatasetUpdates" KeyFieldName="ID"
                    ...
                    <Columns>
                          ...
                          <dx:GridViewDataTextColumn FieldName="JobID" VisibleIndex="7" Width="80px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="GUID" VisibleIndex="8" Width="150px" Visible="false" />       
                          <dx:GridViewDataTextColumn FieldName="DataSourceInstanceID" VisibleIndex="9" Width="80px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="DataSource" VisibleIndex="10" Width="900px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Rows" VisibleIndex="11" Width="100px" Visible="true" />                          	
                          <dx:GridViewDataTextColumn FieldName="StatusID" VisibleIndex="12" Width="80px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Status" VisibleIndex="13" Width="90px" Visible="true" />
                          <dx:GridViewDataDateColumn FieldName="TimeStamp" VisibleIndex="14" Width="120px" Visible="true" />
                          <dx:GridViewDataTextColumn FieldName="Age" VisibleIndex="15" Width="80px" Visible="false" />
                          <dx:GridViewDataTextColumn FieldName="Rank" VisibleIndex="16" Width="80px" Visible="false" />
                      </Columns>
                      <SettingsPager PageSize="10" AlwaysShowPager="True" EllipsisMode="OutsideNumeric" EnableAdaptivity="True">
                          <PageSizeItemSettings Visible="True"></PageSizeItemSettings>
                      </SettingsPager>
